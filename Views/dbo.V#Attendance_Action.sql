...
AS
    SELECT  a.FIGH_FILE_NO ,
            ...
            CAST(a.ENTR_TIME AS VARCHAR(10)) AS ENTR_TIME ,
            CAST(a.EXIT_TIME AS VARCHAR(10)) AS EXIT_TIME,
    ...
    GROUP BY a.FIGH_FILE_NO ,
            ...
            CAST(a.ENTR_TIME AS VARCHAR(10)),
            CAST(a.EXIT_TIME AS VARCHAR(10));
