...
-- =============================================
CREATE PROCEDURE [dbo].[ADT_SAVE_F]
...
BEGIN
   ...
   SET @AccessString = N'<AP><UserName>' + SUSER_NAME() + '</UserName><Privilege>136</Privilege><Sub_Sys>5</Sub_Sys></AP>';	
   EXEC iProject.dbo.SP_EXECUTESQL N'SELECT @ap = DataGuard.AccessPrivilege(@P1)',N'@P1 ntext, @ap BIT OUTPUT',@AccessString , @ap = @ap output
   IF @AP = 0 
   BEGIN
      RAISERROR ( N'خطا - عدم دسترسی به ردیف 136 سطوح امینتی', -- Message text.
               16, -- Severity.
               1 -- State.
               );
      RETURN;
