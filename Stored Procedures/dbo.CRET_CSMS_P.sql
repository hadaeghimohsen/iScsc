...
BEGIN
   ...
   */
   ...
   -- تبریک تولد 
	...
	--------------------------*********************************
	--------------------------*********************************	
	-- یاد آوری اقلام خرید از قبل
	IF EXISTS(SELECT * FROM Message_Broadcast WHERE MSGB_TYPE IN ('009') AND STAT = '002' )
	BEGIN
	   -- در این قسمت برای گزینه درآمد متفرقه لحاظ میشود
	   -- مشتری شامل مشتریان اشتراکی و مشتریان مهمان رو داریم
	   -- فاکتور ها باید ایتم درامد متفرقه را چک کنیم که دارای تاریخ انقضا یا همان یادآوری هستن رو پردازش کنیم
	   PRINT 'Hi Honey';
	END;
END
GO
