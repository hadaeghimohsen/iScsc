...
BEGIN
   ...
   INSERT INTO Club (REGN_PRVN_CNTY_CODE, REGN_PRVN_CODE, REGN_CODE, NAME, POST_ADRS, EMAL_ADRS, WEB_SITE,CORD_X, CORD_Y, TELL_PHON, CELL_PHON, ZIP_CODE, ECON_CODE, CLUB_DESC, INST_PAGE)
   VALUES (@Regn_Prvn_Cnty_Code, @Regn_Prvn_Code, @Regn_Code, @Name, @Post_Adrs, @Emal_Adrs, @Web_Site, @Cord_X, @Cord_Y, @Tell_Phon, @Cell_Phon, @Zip_Code, @Econ_Code, @Club_Desc, @Inst_Page);
END
GO
