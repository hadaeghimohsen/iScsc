...
GO
ALTER TABLE [dbo].[Log_Operation] ADD CONSTRAINT [FK_LGOP_MBSP] FOREIGN KEY ([FIGH_FILE_NO], [MBSP_RWNO], [MBSP_RECT_CODE]) REFERENCES [dbo].[Member_Ship] ([FIGH_FILE_NO], [RWNO], [RECT_CODE])
GO
