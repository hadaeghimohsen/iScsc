...
GO
ALTER TABLE [dbo].[Dresser_Vip_Fighter] ADD CONSTRAINT [FK_DVPF_DRES] FOREIGN KEY ([DRES_CODE]) REFERENCES [dbo].[Dresser] ([CODE]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[Dresser_Vip_Fighter] ADD CONSTRAINT [FK_DVPF_FIGH] FOREIGN KEY ([MBSP_FIGH_FILE_NO]) REFERENCES [dbo].[Fighter] ([FILE_NO]) ON DELETE CASCADE
GO
ALTER TABLE [dbo].[Dresser_Vip_Fighter] ADD CONSTRAINT [FK_DVPF_MBSP] FOREIGN KEY ([MBSP_FIGH_FILE_NO], [MBSP_RWNO], [MBSP_RECT_CODE]) REFERENCES [dbo].[Member_Ship] ([FIGH_FILE_NO], [RWNO], [RECT_CODE])
GO
