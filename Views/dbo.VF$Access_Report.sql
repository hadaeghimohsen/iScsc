...
Begin DesignProperties = 
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "v$AccessReports (iProject.Report)"
            Begin Extent = 
               Top = 6
               Left = 38
               Bottom = 190
   ...
   End
End
', 'SCHEMA', N'dbo', 'VIEW', N'VF$Access_Report', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'dbo', 'VIEW', N'VF$Access_Report', NULL, NULL
GO
