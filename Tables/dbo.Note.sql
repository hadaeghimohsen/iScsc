...
GO
ALTER TABLE [dbo].[Note] ADD CONSTRAINT [FK_NOTE_APBS] FOREIGN KEY ([NTAG_APBS_CODE]) REFERENCES [dbo].[App_Base_Define] ([CODE]) ON DELETE SET NULL
GO
