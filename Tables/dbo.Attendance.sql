            ...
            BEGIN
                ...
                IF EXISTS ( SELECT  *
                    ...
                    BEGIN
                        ...
                        SELECT  @MsgbText = ( SELECT    N'ابطال حضور و غیاب'
                                                        + CHAR(10)
                                                        + N'نام مشترک '
                                                        + a.NAME_DNRM
                                                        + CHAR(10)
                ...
                IF EXISTS ( SELECT  *
                    ...
                    BEGIN         
                        ...
                        IF EXISTS ( SELECT  *
                            ...
                            BEGIN
                                UPDATE  ms
                                SET     ms.SUM_ATTN_MONT_DNRM = ISNULL(ms.SUM_ATTN_MONT_DNRM,
                                                              0) - 1
                                ...
                                WHERE   I.CODE = A.CODE
                                        ...
                                        AND m.CHCK_ATTN_ALRM = '002' -- ورزش مشارکتی 
                                        AND ISNULL(ms.NUMB_OF_ATTN_MONT, 0) > 0
                                        AND ISNULL(ms.NUMB_OF_ATTN_MONT, 0) >= ISNULL(ms.SUM_ATTN_MONT_DNRM,
                                                              0) /*- 1*/
