...
-- =============================================
CREATE FUNCTION [dbo].[VF$StatisticAttendance]
(	
	@FileNo BIGINT	
)
RETURNS TABLE 
...
SELECT SUBSTRING(dbo.GET_MTOS_U(ATTN_DATE), 1, 4) AS YEAR,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '07:00' AND '07:59' THEN 1 END) AS _07_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '08:00' AND '08:59' THEN 1 END) AS _08_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '09:00' AND '09:59' THEN 1 END) AS _09_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '10:00' AND '10:59' THEN 1 END) AS _10_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '11:00' AND '11:59' THEN 1 END) AS _11_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '12:00' AND '12:59' THEN 1 END) AS _12_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '13:00' AND '13:59' THEN 1 END) AS _13_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '14:00' AND '14:59' THEN 1 END) AS _14_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '15:00' AND '15:59' THEN 1 END) AS _15_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '16:00' AND '16:59' THEN 1 END) AS _16_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '17:00' AND '17:59' THEN 1 END) AS _17_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '18:00' AND '18:59' THEN 1 END) AS _18_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '19:00' AND '19:59' THEN 1 END) AS _19_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '20:00' AND '20:59' THEN 1 END) AS _20_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '21:00' AND '21:59' THEN 1 END) AS _21_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '22:00' AND '22:59' THEN 1 END) AS _22_CONT,
       ...
       SUM(CASE WHEN ENTR_TIME BETWEEN '23:00' AND '23:59' THEN 1 END) AS _23_CONT,
