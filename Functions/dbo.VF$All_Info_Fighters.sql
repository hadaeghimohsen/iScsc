...
RETURN
(
SELECT dbo.Fighter.FILE_NO, dbo.Fighter_Public.RWNO, dbo.Fighter.REGN_PRVN_CODE, dbo.Fighter.REGN_CODE, dbo.Fighter_Public.RQRO_RQST_RQID, dbo.Fighter_Public.NATL_CODE, dbo.Fighter_Public.GLOB_CODE, dbo.Fighter_Public.POST_ADRS, 
