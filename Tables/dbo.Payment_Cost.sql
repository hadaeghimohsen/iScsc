...
GO
ALTER TABLE [dbo].[Payment_Cost] ADD CONSTRAINT [FK_PYCO_COST_APBS] FOREIGN KEY ([PYCO_APBS_CODE]) REFERENCES [dbo].[App_Base_Define] ([CODE])
GO
ALTER TABLE [dbo].[Payment_Cost] ADD CONSTRAINT [FK_PYCO_PYDT] FOREIGN KEY ([PYDT_CODE]) REFERENCES [dbo].[Payment_Detail] ([CODE])
GO
