...
-- =============================================
CREATE PROCEDURE [dbo].[HRS_TRQT_P]
...
BEGIN
   ...
   SET @AccessString = N'<AP><UserName>' + SUSER_NAME() + '</UserName><Privilege>210</Privilege><Sub_Sys>5</Sub_Sys></AP>';	
   EXEC iProject.dbo.SP_EXECUTESQL N'SELECT @ap = DataGuard.AccessPrivilege(@P1)',N'@P1 ntext, @ap BIT OUTPUT',@AccessString , @ap = @ap output
   IF @AP = 0 
   BEGIN
      RAISERROR ( N'خطا - عدم دسترسی به ردیف 210 سطوح امینتی', -- Message text.
               16, -- Severity.
               1 -- State.
               );
      RETURN;
