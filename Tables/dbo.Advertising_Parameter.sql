...
GO
ALTER TABLE [dbo].[Advertising_Parameter] ADD CONSTRAINT [FK_ADVP_CTGY] FOREIGN KEY ([CTGY_CODE]) REFERENCES [dbo].[Category_Belt] ([CODE]) ON DELETE SET NULL
GO
ALTER TABLE [dbo].[Advertising_Parameter] ADD CONSTRAINT [FK_ADVP_MTOD] FOREIGN KEY ([MTOD_CODE]) REFERENCES [dbo].[Method] ([CODE]) ON DELETE SET NULL
GO
ALTER TABLE [dbo].[Advertising_Parameter] ADD CONSTRAINT [FK_ADVP_RQTP] FOREIGN KEY ([RQTP_CODE]) REFERENCES [dbo].[Request_Type] ([CODE]) ON DELETE SET NULL
GO
