...
GO
ALTER TABLE [dbo].[Receive_Document] ADD CONSTRAINT [FK_RCDC_RQRO] FOREIGN KEY ([RQRO_RQST_RQID], [RQRO_RWNO]) REFERENCES [dbo].[Request_Row] ([RQST_RQID], [RWNO]) ON DELETE CASCADE
GO
